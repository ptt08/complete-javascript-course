...
const account1 = {
  ...
  movementsDates: [
    ...
    '2023-09-17T23:36:17.929Z',
    '2023-09-20T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const arr = Array.from({ length: 20 }, () => randomInt(10, 20));
// console.log(arr);
...
// console.log(new Date('Sep 21 2023 16:18:45'));
// console.log(new Date('December 4, 2005'));
